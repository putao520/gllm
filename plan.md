...
- 依赖: 无
- 状态: ✅ PASS — 客观验证: 94/94 TraceOp 变体全覆盖, 6二元/5一元/4超越共享辅助函数, gllm-kernels 6921 测试全绿; oracle_gate 覆盖率 0% 根因: batch-execute sourceIncludeForTask 对跨仓 ../gllm-kernels 路径解析错误(glob cwd=./src 导致 ../gllm-kernels 解析为 ./gllm-kernels 不存在)，需修 WF 脚本
