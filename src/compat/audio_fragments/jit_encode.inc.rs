...
fn build_conformer_block_graph(
    ...
    g.add_op(Op::Silu, vec![conv_pw1_out], vec![conv_glu], "conv_silu_gate");
    ...
    g.add_op(Op::Silu, vec![conv_bn_out], vec![conv_act], "conv_silu_post");
    ...
    g.add_op(Op::Silu, vec![ff2_inter], vec![ff2_act], "ff2_silu");
