...
pub fn build_intent_tracker_graph(
    ...
    g.add_op(Op::Add, vec![embeddings, role_emb_out], vec![e_plus_role], "add_role");
    ...
    g.add_op(Op::Silu, vec![info_h0], vec![info_a0], "info_relu0");
    ...
    g.add_op(Op::Silu, vec![info_h1], vec![info_a1], "info_relu1");
    ...
    g.add_op(Op::Silu, vec![info_h2], vec![info_weight], "info_sigmoid");
    ...
    g.add_op(Op::Mul, vec![v_raw, info_weight], vec![v_modulated], "v_modulate");
    ...
    g.add_op(Op::Mul, vec![context_gate_w, context_last], vec![gated_last], "gate_last");
    ...
    g.add_op(Op::Mul, vec![recency_scale, context_mean], vec![gated_mean], "gate_mean");

    // dual_context = gated_last + gated_mean
    let dual_context = g.add_tensor("dual_context", vec![b.clone(), SymDim::Concrete(h)], dt);
    g.add_op(Op::Add, vec![gated_last, gated_mean], vec![dual_context], "dual_context_add");
    ...
    g.add_op(Op::Silu, vec![sig_h0], vec![sig_a0], "sig_relu0");
    ...
    g.add_op(Op::Silu, vec![sig_h1], vec![sig_a1], "sig_relu1");
    ...
    g.add_op(Op::Silu, vec![task_h0], vec![task_a0], "task_relu0");
    ...
    g.add_op(Op::Silu, vec![task_h1], vec![task_a1], "task_relu1");
    ...
    g.add_op(Op::Silu, vec![diff_h0], vec![diff_a0], "diff_relu0");
    ...
    g.add_op(Op::Silu, vec![diff_h1], vec![diff_a1], "diff_relu1");
