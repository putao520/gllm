...
## reqLedger
<!-- 清空 2026-07-31: REQ-DIST-001..034 是旧"分布式推理"历史任务残留（2026-06-23 plan），
     与当前 Gemma4 单机 JIT 调试任务无关。用户从未要求实现 NCCL 分布式。
     清空避免 SPEC 完成度校验把历史需求当当前 demand 反复阻塞。 -->
（无当前活跃需求 — Gemma4 logits overflow 已根治，commit 46563fc7）
